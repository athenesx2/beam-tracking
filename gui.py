...
class app(tk.Tk):
    ...
    def __init__(self):
        ...
        frame1, frame2, frame3 = (
            tk.Frame(self, background="royalblue1", width=1600),
            tk.Frame(self, background="royalblue1", width=1600),
            tk.Frame(self, background="royalblue1", width=1600),
        )
        bar = tk.Canvas(
        ...
        a = tk.Canvas(
            frame1, background="royalblue1", height=40, width=40, highlightthickness=0
        )
        a.grid(row=1, column=6)
        a.create_line(20, 0, 20, 49, width=4)
        a = tk.Canvas(
            frame3, background="royalblue1", height=40, width=40, highlightthickness=0
        )
        a.grid(row=1, column=6)
        a.create_line(20, 0, 20, 49, width=4)
        a = tk.Canvas(
        ...
        self.co = self.canvaco.create_oval(4, 4, 36, 36, width=4, fill="red")
    ...
    def save(self):
        ...
        self.saveframe.geometry("700x500")
        ...
        canvaco = tk.Canvas(
            frame4, background="royalblue1", height=40, width=40, highlightthickness=0
        )
        co = canvaco.create_oval(4, 4, 36, 36, width=4, fill="orange")
    ...
    def automatical(self):
        ...
        self.automaticalframe.geometry("400x200")
    ...
    def acquisition(self, delay):
        ...
        self.acquisitionframe.geometry("650x650")
    ...
    def comparing(self):
        ...
        self.compareframe.geometry("700x500")
        ...
        def compareencore():
            ...
            if selection:
                ...
                self.fenetre[n].place(
                    x=100 + 10 * len(self.fenetre), y=150 + 10 * len(self.fenetre)
                )
                self.image[n] = image
    ...
    def streaming(self):
        if self.onoff == 0:
            ...
            self.fenetre["video"].place(x=100, y=150)
    ...
    def photoing(self):
        if self.canvaco.itemcget(self.co, "fill") == "light green":
            ...
            self.cbdata["values"] = self.fenetrestr
            self.fenetre[f"photo {n}"].place(x=100 + 10 * n, y=150 + 10 * n)
    ...
    def scaning(self):
        ...
        self.widget.pack()
        self.scanframe.place(x=500, y=250)
        ...
        try:
            if self.canvaco.itemcget(self.co, "fill") == "light green":
                ...
                self.sslistbox.insert(
                    0,
                    f"({barycentre[k][0]},{barycentre[k][1]})  ->   +({-self.actbary[0]+barycentre[k][0]},{-self.actbary[1]+barycentre[k][1]})",
                )
                contour = tuplebar[1]
                listimage = [image]
                couleur = [(0, 255, 0)]
